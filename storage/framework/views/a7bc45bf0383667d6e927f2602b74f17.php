...
<table class="cart_table table table-bordered table-striped text-center mb-0">
    ...
    <tbody>
        ...
        <tr>
            <td>
                <button type="button" class="btn btn-sm btn-outline-danger cart_remove" data-id="<?php echo e($value->rowId); ?>">
           ...
           <div class="qty-cart vcart-qty">
            <div class="quantity">
             <button type="button" class="minus cart_decrement" data-id="<?php echo e($value->rowId); ?>">
                 <i class="fas fa-minus"></i>
             </button>
             <input type="text" value="<?php echo e($value->qty); ?>" readonly />
             <button type="button" class="plus cart_increment" data-id="<?php echo e($value->rowId); ?>">
...
<!-- cart js end --><?php /**PATH X:\sagor\sailor\resources\views/frontEnd/layouts/ajax/cart.blade.php ENDPATH**/ ?>