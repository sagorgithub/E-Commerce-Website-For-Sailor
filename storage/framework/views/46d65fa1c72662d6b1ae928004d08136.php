...
unset($__errorArgs, $__bag); ?>
                        ...
                        <div class="form-group mb-3">
                            <button class="submit-btn btn-primary"> লগিন </button>
                        </div>
                     <!-- col-end -->
                     </form>
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('frontEnd.layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH X:\sagor\sailor\resources\views/frontEnd/layouts/customer/login.blade.php ENDPATH**/ ?>