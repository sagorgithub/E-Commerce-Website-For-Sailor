    ...
    <?php if($generalsetting->facebook_pixel_id && $generalsetting->facebook_server_side_tracking): ?>
        ...
        <script>
            window.facebookTrackingConfig = {
                pixelId: '<?php echo e($generalsetting->facebook_pixel_id); ?>',
                apiVersion: '<?php echo e($generalsetting->facebook_conversion_api_version); ?>',
                enhancedEcommerce: {
                    {
                            ...
                            <li class="parent-subcategory">
                                ...
                                <ul class="third-nav" style="display: none;">
                                    <?php $__currentLoopData = $subcategory->childcategories; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $childcat): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <li class="childcategory"><a href="<?php echo e(url('products/' . $childcat->slug)); ?>"
                                                class="menu-childcategory-name"><?php echo e($childcat->childcategoryName); ?></a></li>
                                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                </ul>
                            </li>
                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
            ...
            <div class="container-fluid">
                <div class="row align-items-center">
                    <div class="col-md-2 col-5">
                        <a href="<?php echo e(route('home')); ?>" class="modern-logo">
                            <?php if($generalsetting->white_logo): ?>
                                <img src="<?php echo e(asset($generalsetting->white_logo)); ?>" alt="<?php echo e($generalsetting->name ?? 'GulNoze'); ?>"
                                    style="max-height: 50px; width: auto;">
                            <?php else: ?>
                                <?php echo e($generalsetting->name ?? 'GUlNOZE'); ?>
                    ...
                    <div class="col-md-3 col-6 order-md-3 order-2 text-end d-none d-md-block">
                        <div class="d-flex justify-content-end align-items-center" style="gap: 20px;">
                            <a href="<?php echo e(route('customer.order_track')); ?>" class="modern-user-actions"
                               title="Track Order">
                                <i class="fas fa-shipping-fast"></i>
                            </a>
                            <?php if(Auth::guard('customer')->user()): ?>
                                <a href="<?php echo e(route('customer.account')); ?>" class="modern-user-actions"
                                    
                                    title="<?php echo e(Str::limit(Auth::guard('customer')->user()->name, 14)); ?>">
                                    <i class="fas fa-user-circle" ></i>
                                </a>
                            <?php else: ?>
                                <a href="<?php echo e(route('customer.login')); ?>" class="modern-user-actions"
                                    title="Login / Sign Up">
                                    <i class="fa-solid fa-user"></i>
                                </a>
                            <?php endif; ?>
                            <a href="<?php echo e(route('customer.checkout')); ?>" class="modern-user-actions position-relative"
                               
                                title="Cart - <?php echo e($subtotal); ?>">
                                <i class="fas fa-shopping-bag" ></i>
                                <span class="modern-cart-count" id="cart_count"
                                    style="position: absolute; top: -8px; right: -8px; background: #ff4757; color: white; border-radius: 50%; width: 18px; height: 18px; display: flex; align-items: center; justify-content: center; font-size: 0.7rem; font-weight: bold;"><?php echo e(Cart::instance('shopping')->count()); ?></span>
                            </a>
                        </div>
                    </div>
                </div>
        ...
        <a href="<?php echo e(route('customer.checkout')); ?>">
            <div class="cart-button-big-device">
                <div class='cart-button-uper'>
                    ...
                    <p><?php echo e(Cart::instance('shopping')->count()); ?> ITEMS</p>
                </div>
...
</html><?php /**PATH X:\sagor\sailor\resources\views/frontEnd/layouts/master_old.blade.php ENDPATH**/ ?>