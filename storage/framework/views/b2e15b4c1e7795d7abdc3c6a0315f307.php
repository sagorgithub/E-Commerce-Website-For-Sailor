                                ...
                                <li class="nav-item position-relative">
                                    ...
                                    <div class="shopping-bag-main">
                                            ...
                                            <div class="card mb-3">
                                                <div class="row g-0">
                                                    <div class="col-xs-12 col-sm-12 col-md-3 col-lg-3">
                                                        <img src="<?php echo e(asset($value->options->image)); ?>" class="img-fluid" alt="">
                                                    </div>
                                                    <div class="col-xs-12 col-sm-12 col-md-9 col-lg-9">
                                                        <div class="card-body">
                                                            ...
                                                            <div class="remove-product w-100">
                                                                <a href="#" data-id="<?php echo e($value->rowId); ?>" class="remove-item cart_remove">
                                        ...
                                        <div class="button-sets">
                                            <a class="btn btn-outline-primary view-shopping" href="<?php echo e(route('customer.cart')); ?>">view shopping bag</a>
                                            <a class="btn btn-secondary checkout" href="<?php echo e(route('customer.checkout')); ?>">checkout</a>
                                        </div>
                                    </div>
                                </li>
                            </ul>
                            ...
                            <?php $__currentLoopData = $menucategories; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $scategory): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <li class="nav-item dropdown has-megamenu">
                                    <a class="nav-link dropdown-toggle "
                                        href="<?php echo e(url('category/' . $scategory->slug)); ?>"><?php echo e($scategory->name); ?>
