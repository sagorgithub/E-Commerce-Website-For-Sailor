...
<head>
    ...
    <title><?php echo $__env->yieldContent(''); ?> <?php echo e($generalsetting->name); ?></title>
    ...
    <link rel="stylesheet" href="<?php echo e(asset('/frontEnd/css/modern-product-design.css')); ?>" />
    <link rel="stylesheet" href="<?php echo e(asset('frontEnd/css/zombie-style.css')); ?>" />
    ...
    <link rel="stylesheet" href="<?php echo e(asset('/frontEnd/css/style_tow.css')); ?>" />
    <link rel="stylesheet" href="<?php echo e(asset('/frontEnd/css/style.css')); ?>" />
    <link rel="stylesheet" href="<?php echo e(asset('/frontEnd/fonts/bebas-regular-webfont.woff2')); ?>">
...
<body>
                            ...
                            <div class="dropdown-box">
                                <select class="form-select form-contol" aria-label="Default select example">
                                    ...
                                    <?php $__currentLoopData = $menucategories; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $scategory): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <option value="<?php echo e($scategory->name); ?>"><?php echo e($scategory->name); ?></option>
                                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                        ...
                        <div class="icon-sets">
                            <ul class="nav justify-content-end">
                                ...
                                <li class="nav-item position-relative">
                                    <a class="nav-link" href="<?php echo e(route('customer.cart')); ?>">
                                    ...
                                    <div class="shopping-bag-main">
                                        <div class="shopping-title">
                                            <h3>Shopping bag (<?php echo e(Cart::instance('shopping')->count()); ?>)</h3>
                                        </div>
                                                ...
                                                <div class="card mb-3">
                                                    <div class="row g-0">
                                                        <div class="col-xs-12 col-sm-12 col-md-3 col-lg-3">
                                                            <img src="<?php echo e(asset($value->options->image)); ?>" class="img-fluid"
                                                                alt="">
                                                        </div>
                                                        <div class="col-xs-12 col-sm-12 col-md-9 col-lg-9">
                                                            <div class="card-body">
                                                                <div class="products-namebox">
                                                                    <h3 class="name">
                                                                        <a
                                                                            href="<?php echo e(route('product', $value->options->slug)); ?>"><?php echo e(Str::limit($value->name, 20)); ?></a>
                                                                    </h3>
                                                                    <h3 class="price">৳ <?php echo e($value->price); ?> </h3>
                                                                </div>
                                                                <div class="price-description">
                                                                    <h3>Qty: <?php echo e($value->qty); ?></h3>
                                                                    <h3>Variant: <?php echo e($value->options->product_size); ?></h3>
                                                                </div>
                                                                <div class="remove-product w-100">
                                                                    <a href="#" data-id="<?php echo e($value->rowId); ?>"
                                        ...
                                        <div class="amount-box">
                                            ...
                                            <h3 class="text-end">৳ <?php echo e($subtotal); ?> </h3>
                                        </div>
                                        <div class="button-sets">
                                            <a class="btn btn-outline-primary view-shopping"
                                                href="<?php echo e(route('customer.cart')); ?>">view shopping bag</a>
                                            <a class="btn btn-secondary checkout"
                                                href="<?php echo e(route('customer.checkout')); ?>">checkout</a>
                                        </div>
                                    </div>
                                </li>
                            </ul>
                        ...
                        <ul class="navbar-nav show-lg">
                            ...
                            <?php $__currentLoopData = $menucategories; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $scategory): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <li class="nav-item dropdown has-megamenu">
                                    <a class="nav-link dropdown-toggle" href="<?php echo e(url('category/' . $scategory->slug)); ?>">
                                                    ...
                                                    <div class="col-12">
                                                        <div class="menugrid-main">
                                                            ...
                                                            <div class="gridbox-single left-image-box">
                                                                <a href="#">
                                                                    <img src="<?php echo e(asset('/frontEnd/images/singapore.jpg')); ?>"
                                                                        alt="" class="img-fluid">
                                                                </a>
                                                            </div>
                                                            ...
                                                            <?php $__currentLoopData = $subcategories->take($maxColumns); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $subcategory): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                            ...
                                                            <?php for($i = $subcategories->count(); $i < $maxColumns; $i++): ?>
                                                            ...
                                                            <div class="gridbox-single">
                                                                <a href="#">
                                                                    <img src="<?php echo e(asset('/frontEnd/images/sailorbucket.jpg')); ?>"
                                                                        alt="" class="img-fluid">
                                                                </a>
                                                            </div>
                                                            <div class="gridbox-single">
    ...
    <?php if($generalsetting->facebook_pixel_id && $generalsetting->facebook_server_side_tracking): ?>
        <script src="<?php echo e(asset('assets/js/facebook-tracking.js')); ?>"></script>
    <?php endif; ?>
    ...
    <script src="<?php echo e(asset('/frontEnd/js/modern-product-interactions.js')); ?>"></script>
</body>

</html><?php /**PATH X:\sagor\sailor\resources\views/frontEnd/layouts/master.blade.php ENDPATH**/ ?>