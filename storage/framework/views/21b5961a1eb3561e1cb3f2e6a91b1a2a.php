    ...
    <div id="wrapper">
      ...
      <div class="navbar-custom">
        <div class="container-fluid">
          <ul class="list-unstyled topnav-menu float-end mb-0">
            ...
            <li class="dropdown notification-list topbar-dropdown">
              <a class="nav-link dropdown-toggle nav-user me-0 waves-effect waves-light" data-bs-toggle="dropdown" href="#" role="button" aria-haspopup="false" aria-expanded="false">
                <img src="<?php echo e(asset(Auth::user()->image ?? 'https://placehold.co/400x400/f8bbd0/ffffff?text=Prduct')); ?>" alt="user-image" class="rounded-circle" />
          ...
          <ul class="list-unstyled topnav-menu topnav-menu-left m-0">
            ...
            <li class="dropdown d-none d-xl-block">
              <a class="nav-link dropdown-toggle waves-effect waves-light" href="<?php echo e(url('/home')); ?>" target="_blank"> <i data-feather="globe"></i> Visit Only </a>
            </li>
            ...
            <ul id="side-menu">
              ...
              <li>
                ...
                <div class="collapse" id="siebar-product">
                  <ul class="nav-second-level">
                    ...
                    <li>
                      <a href="<?php echo e(route('skintypes.index')); ?>"><i data-feather="file-plus"></i> Skin Types</a>
                    </li>
                    <li>
                      <a href="<?php echo e(route('skinconcerns.index')); ?>"><i data-feather="file-plus"></i> Skin Concerns</a>
                    </li>
                    <li>
              ...
              <li>
                ...
                <div class="collapse" id="sidebar-landing-page">
                  <ul class="nav-second-level">                   
                    <li>
                      <a href="<?php echo e(route('landing-pages.index')); ?>"><i data-feather="file-plus"></i> Landing Pages</a>
                    </li>
                    <li>
                      <a href="<?php echo e(route('landing-pages.create')); ?>"><i data-feather="file-plus"></i> Create Landing Page</a>
                    </li>
                    <li>
                      <a href="<?php echo e(route('campaign.create')); ?>"><i data-feather="file-plus"></i> Create Campaign</a>
                    </li>
                    <li>
                      <a href="<?php echo e(route('campaign.index')); ?>"><i data-feather="file-plus"></i> Campaign</a>
                    </li>
                    <li>
                      <a href="<?php echo e(route('campaign.videos.index')); ?>"><i data-feather="file-plus"></i> Video</a>
                    </li>
                  </ul>
                </div>
              </li>
              ...
              <li>
                ...
                <div class="collapse" id="siebar-sitesetting">
                  <ul class="nav-second-level">
                    ...
                    <li>
                      <a href="<?php echo e(route('facebook-tracking.index')); ?>"><i data-feather="facebook"></i> Facebook Tracking</a>
                    </li>
                  </ul>
                </div>
              </li>
      ...
      <div class="content-page">
        ...
        <footer class="footer">
          <div class="container-fluid">
            <div class="row">
              <div class="col-md-12 text-end">&copy; Developed By <a href="https://developerszone.info/" target="_blank">Developer Zone</a></div>
            </div>
          </div>
        </footer>
        <!-- end Footer -->
...
<?php /**PATH X:\sagor\sailor\resources\views/backEnd/layouts/master.blade.php ENDPATH**/ ?>