...
class CustomerController extends Controller
{
    ...
    public function order_save(Request $request){
       ...
       // order details data save
        ...
        // Facebook Server-Side Tracking - Purchase Event
        if (app(\App\Services\FacebookTrackingService::class)->isEnabled()) {
            $userData = [
            ...
            app(\App\Services\FacebookTrackingService::class)->sendPurchaseEvent($orderData, $userData);
        }
    ...
    public function order_success($id) {
        $order = Order::with('orderdetails')->where('id',$id)->firstOrFail();
