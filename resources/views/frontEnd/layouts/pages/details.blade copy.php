                        ...
                        <div class="container">
                            <div class="row">
                                <div class="col-sm-6 position-relative">
                                            ...
                                            <div class="sale-badge-inner">
                                                <div class="sale-badge-box">
                                                    <span class="sale-badge-text">
                                                        <p> @php
                                                            $discount=(((($details->old_price)-($details->new_price))*100)
                                                            / ($details->old_price)) @endphp {{ number_format($discount,
                                                            0) }}%</p>
                                                        ছাড়
                                                    </span>
                                                </div>
                                    ...
                                    @if ($details->images->count() > 4) thumb_slider owl-carousel @endif">
                                        ...
                                        <div class="product">
                                            <div class="product-cart">
                                                ...
                                                <div class="details-ratting-wrapper">
                                                    ...
                                                    @if ($averageRating >= 0 && $averageRating <= 5) @for ($i=1; $i
                                                        <=$filledStars; $i++) <i class="fas fa-star"></i>
                                                        @endfor
                                                        ...
                                                        @for ($i = 1; $i <= $emptyStars; $i++) <i class="far fa-star">
                                                            </i>
                                                            @endfor
                                                ...
                                                <form action="{{ route('cart.store') }}" method="POST" name="formName">
                                                    ...
                                                    <div class="image-gallery-detailsPage">
                                                        <div class="color-title-detailsPage">
                                                            <p id="selected-color-detailsPage">Color: {{
                                                                $details->images->first()->title ?? 'Color' }}</p>
                                                        </div>
                                                        <div class="image-thumbnails-detailsPage d-flex gap-3">
                                                            @foreach($details->images as $image)
                                                            <div class="image-thumbnail-detailsPage">
                                                                <input type="radio" id="image{{ $image->id }}"
                                                                    name="product_color" value="{{ $image->title }}"
                                                                    onclick="selectImage(this, '{{ $image->title }}')" />
                                                                <label for="image{{ $image->id }}">
                                                                    <img src="{{ asset($image->image) }}"
                                                                        alt="Product Image"
                                                                        class="img-thumbnail-detailsPage" />
                                                                    <span
                                                                        class="selected-icon-detailsPage">&#10004;</span>
                                                                    <!-- Checkmark icon -->
                                                                </label>
                                                            </div>
                                                            @endforeach
                                                    ...
                                                    <div class="row">
                                                        ...
                                                        <div class="d-flex single_product col-sm-12">
                                                            ...
                                                            <form action="{{ route('cart.store') }}" method="POST"
                                                                name="formName" class='add_cart_btn_home_main'>
                                                                @csrf
                                                                <input type="hidden" name="id"
                                                                    value="{{ $details->id }}" />
                                                                <input type="hidden" name="qty" value="1" />
                                                                <input type="submit" class=" add_cart_btn btn px-4"
                                                                    onclick="add_to_cart_details(this,event)"
                                                                    name="add_cart" value="কার্টে যোগ করুন" />
                                                            </form>
                                                            <div class="pro_btn col-lg-6 col-md-6 col-sm-12 col-12"
                                                                style="padding-left:0;">
                                                                <!-- Button Design -->
                                                                <button class="btn btn-primary"
                                                                    style="width: 100%; max-width: 100%; padding: 10px; cursor: pointer; margin: 5px; border-radius: 5px;"
                                                                    onclick="document.getElementById('buyNowForm').submit();">
                                                                    অর্ডার করুন
                                                                </button>
                                                                <!-- Hidden Form to Handle Submit -->
                                                                <form id="buyNowForm"
                                                                    action="{{ route('cart.store.buy') }}" method="POST"
                                                    ...
                                                    <div class="mt-md-2 mt-2">
                                                        <h4 class="font-weight-bold">
                                                            ...
                                                            <a class="btn btn-success w-100 call_now_btn"
                                                                id="order_by_whatsapp" onclick="sendOrderByWhatsApp()">
                ...
                <div class="col-sm-12">
                    <div class="description-nav">
                        <ul class="desc-nav-ul">
                            ...
                            <li>
                                <a href="#writeReview" class="btn btn-primary" target="_self">Reviews ({{
                                    $reviews->count() }}) </a>
                            </li>
                        </ul>
                    </div>
        ...
        <div class="container">
            <div class="row">
                                ...
                                <div class="col-sm-12">
                                    <div class="section-head">
                                        ...
                                        <div class="action">
                                            <div>
                                                <button type="button"
                                                    class="btn btn-primary details-action-btn question-btn btn-overlay"
                                    ...
                                    <div class="empty-content">
                                        ...
                                        <p class="empty-text">This product has no reviews yet. Be the first one to write
                                            a review.</p>
                                    </div>
                                    @endif
                                                ...
                                                <div class="modal-body">
                                                    <div class="insert-review">
                                                        ...
                                                        <form action="{{ route('customer.review') }}" id="review-form"
                                                            ...
                                                            <div class="form-group">
                                                                <button class="details-review-button btn-primary w-100"
                                                                    type="submit">Submit
                                                                    Review</button>
                                                            </div>
                ...
                <div class="col-sm-4">
                    <div class="pro_vide">
                        <h2>ভিডিও</h2>
                        <iframe width="100%" height="315" src="https://www.youtube.com/embed/{{ $details->pro_video }}"
                                ...
                                <div class="card-body d-flex flex-column">
                                    ...
                                    <div class="mt-auto">
                                        <div class="d-flex align-items-baseline">
                                            ...
                                            <p class="ms-2 text-muted text-decoration-line-through">{{
                                                $product->old_price }}</p>
                                        </div>
                                        <div class="d-grid gap-2 d-sm-flex mt-3">
                                            <form action="{{ route('cart.store') }}" method="POST" style="flex: 1;">
                                                ...
                                                <input type="hidden" name="qty" value="1" />
                                                {{-- <button type="submit" class="zombie-btn-cart" style="width: 100%;"
                                                    onclick="add_to_cart(this,event)">ADD TO CART</button> --}}
                                                <button type="submit"
                                                    class="btn btn-outline-primary w-100 fw-bold beauty-btn-sm-text">Add
                                                    to Cart</button>
                                            </form>
                                            <form action="{{ route('cart.store.buy') }}" method="POST" style="flex: 1;">
                                                ...
                                                <input type="hidden" name="id" value="{{ $product->id }}" />
                                                <input type="hidden" name="qty" value="1" />
                                                {{-- <button type="submit" class="zombie-btn-buy"
                                                    style="width: 100%;">BUY NOW</button> --}}
                                                <button type="submit"
                                                    class="btn btn-primary w-100 fw-bold beauty-btn-sm-text">Buy
                                                    Now</button>
                                            </form>
                                        </div>
                                    </div>
