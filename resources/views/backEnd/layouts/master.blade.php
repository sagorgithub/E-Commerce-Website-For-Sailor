      ...
      <div class="navbar-custom">
        <div class="container-fluid">
          ...
          <ul class="list-unstyled topnav-menu topnav-menu-left m-0">
            ...
            <li class="dropdown d-none d-xl-block">
              <a class="nav-link dropdown-toggle waves-effect waves-light" href="{{ url('/home') }}" target="_blank"> <i data-feather="globe"></i> Visit Only </a>
            </li>
            ...
            <ul id="side-menu">
              ...
              <li>
                ...
                <div class="collapse" id="siebar-product">
                  <ul class="nav-second-level">
                    ...
                    <li>
                      <a href="{{route('skintypes.index')}}"><i data-feather="file-plus"></i> Skin Types</a>
                    </li>
                    <li>
                      <a href="{{route('skinconcerns.index')}}"><i data-feather="file-plus"></i> Skin Concerns</a>
                    </li>
                    <li>
              ...
              <li>
                ...
                <div class="collapse" id="sidebar-landing-page">
                  <ul class="nav-second-level">                   
                    <li>
                      <a href="{{route('landing-pages.index')}}"><i data-feather="file-plus"></i> Landing Pages</a>
                    </li>
                    <li>
                      <a href="{{route('landing-pages.create')}}"><i data-feather="file-plus"></i> Create Landing Page</a>
                    </li>
                    <li>
                      <a href="{{route('campaign.create')}}"><i data-feather="file-plus"></i> Create Campaign</a>
                    </li>
                    <li>
              ...
              <li>
                ...
                <div class="collapse" id="siebar-sitesetting">
                  <ul class="nav-second-level">
                    ...
                    <li>
                      <a href="{{route('facebook-tracking.index')}}"><i data-feather="facebook"></i> Facebook Tracking</a>
                    </li>
                  </ul>
                </div>
              </li>
